...
response.logo = A(B('Duty','Calls'),XML('&trade;&nbsp;'),
                  _class="brand",_href="/duty_calls")
response.title = request.application.replace('_',' ').title()
response.subtitle = T('Your residents need help...')

## read more at http://dev.w3.org/html5/markup/meta.name.html
response.meta.author = 'Isaac Dontje Lindell <i@isaacdontjelindell.com>'
